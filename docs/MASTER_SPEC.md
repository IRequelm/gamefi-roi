...
- G17 introduces referral operations: protected single-operator workflow, coverage states, safe referral editing, work queue tasks, metadata-only health checks, and manual verified revenue entry.
