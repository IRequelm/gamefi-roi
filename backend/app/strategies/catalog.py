...
OPPORTUNITIES = (
    _opportunity(
        ...
        logo_asset="/assets/logos/defi-kingdoms.png",
        logo_alt="DeFi Kingdoms logo",
        logo_source_reference=("DeFi Kingdoms official documentation", "https://docs.defikingdoms.com/"),
    ...
    _opportunity(
        ...
        logo_asset="/assets/logos/akash.svg",
        logo_alt="Akash Network logo",
        logo_source_reference=("Akash Network official website", "https://akash.network/providers/"),
        guidance=OpportunityGuidance(
