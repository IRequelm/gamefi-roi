...
class DiscoveryRecordModel(Base):
    ...
    approval_status: Mapped[str] = mapped_column(String(32), nullable=False, default="NOT_REQUIRED", index=True)
    approval_token_hash: Mapped[str | None] = mapped_column(String(128), nullable=True, unique=True)
